...
interface NewsAppApi {
    ...
    suspend fun searchNewsWithFilter(@Query("q") queryText: String, @Query("apiKey") apiKey: String = BuildConfig.NEWS_API_KEY, @Query("country") country: String? = null, @Query("category") category: String? = null, @Query("language") language: String? = null): Response<NewsResponse>
}